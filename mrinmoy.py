...
TOKEN = '7112251571:AAFjHe8gSPkUKH0Qd32HlyFblCFqnSLvQOo'  # Replace with your actual bot token
...
EXEMPTED_USERS = [7464869171, 6377882036]
...
def bgmi_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./mrinmoy {target_ip} {target_port} {default_duration} 677")
